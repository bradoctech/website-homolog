      ...
      <div class="row row-fluid">
        ...
        <div class="col-md-12">
          <div
            ...
            data-margin="30"
          >
            <div v-for="(list,index) in lists" :key="index" class="iq-masonry-item item html ">
              <div class="iq-portfolio">
                <a href="/template-parts/portfolio-detail" class="iq-portfolio-img"><img width="1260" height="954" :src="list.image" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""></a>
