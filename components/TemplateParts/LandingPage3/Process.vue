      ...
      <div class="row ">
        <div class="col-md-4 col-sm-12">
          <div class="xamin-process xamin-circle right wow fadeInUp text-center" data-wow-delay="0.6s">
            <div class="circle-effect"> <img :src="require('../../../assets/images/services/01.png')" alt="fancybox"> </div>
        ...
        <div class="col-md-4 col-sm-12 mt-4 mt-md-0">
          <div class="xamin-process xamin-circle right wow fadeInUp text-center" data-wow-delay="0.6s">
            <div class="circle-effect"> <img :src="require('../../../assets/images/services/02.png')" alt="fancybox"> </div>
        ...
        <div class="col-md-4 col-sm-12 mt-4 mt-md-0">
          <div class="xamin-process xamin-circle wow fadeInUp text-center" data-wow-delay="0.6s">
            <div class="circle-effect"> <img :src="require('../../../assets/images/services/03.png')" alt="fancybox"> </div>
