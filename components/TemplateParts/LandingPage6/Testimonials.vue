        ...
        <div class="col-md-12  wow fadeInUp">
          <div class="owl-carousel testimonial-style owl-loaded owl-drag" data-dots="true" data-nav="true" data-autoplay="true" data-loop="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
            <div class="item text-center">
              <div class="iq-testimonial">
                <div class="testimonial-info">
                  <img alt="#" class="img-fluid rounded-circle" :src="require('../../../assets/images/testimonials/1.jpg')">
            ...
            <div class="item text-center">
              <div class="iq-testimonial">
                <div class="testimonial-info">
                  <img alt="#" class="img-fluid rounded-circle" :src="require('../../../assets/images/testimonials/2.jpg')">
                  <div class="testimonial-name">
                      <h5>Walhan Bobe</h5>
            ...
            <div class="item text-center">
              <div class="iq-testimonial">
                <div class="testimonial-info">
                  <img alt="#" class="img-fluid rounded-circle" :src="require('../../../assets/images/testimonials/3.jpg')">
                  <div class="testimonial-name">
                      <h5>Mark McManus</h5>
